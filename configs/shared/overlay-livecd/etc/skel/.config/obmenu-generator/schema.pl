...
## Custom "Advanced Menu"
   ...
   {end_cat   => undef},
   {begin_cat => ['PyTyle3 Tiler', '/usr/share/icons/Faenza/apps/48/window-manager.png']},
		{item => ['geany -m ~/.config/pytyle3/keybind.py','PyTyle3 Keybinds','geany']},
		{item => ['geany -m ~/.config/pytyle3/config.py','PyTyle3 Config','geany']},
   {end_cat   => undef},
   {end_cat   => undef},
